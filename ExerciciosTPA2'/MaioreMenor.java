...
public class MaioreMenor {
	...
	public static void main(String[] args) {
    	...
    	System.out.println ("Digite idade 1:");
    	 ...
    	 System.out.println ("Digite idade 4:");
    	 idade4 = ler. nextDouble (); //leia(idade4)
    	 
    	 System.out.println ("Digite idade 5:");
    	 idade5 = ler. nextDouble (); //leia(idade5)

    	 if(idade1 >= 18) {
    		 qtdMaior = qtdMaior + 1;
    		 System.out.println ("Aluno1 é maior de idade");
    	 }else {
    		 System.out.println ("Aluno1 é menor de idade");
    	 }
    	 if(idade2 >= 18) {
    		 qtdMaior = qtdMaior + 1;
    		 System.out.println ("Aluno2 é maior de idade");
    	 }else {
    		 System.out.println ("Aluno2 é menor de idade");
    	 }
    	 if(idade3 >= 18) {
    		 qtdMaior = qtdMaior + 1;
    		 System.out.println ("Aluno3 é maior de idade");
    	 }else {
    		 System.out.println ("Aluno3 é menor de idade");
    	 }
    	 if(idade4 >= 18) {
    		 qtdMaior = qtdMaior + 1;
    		 System.out.println ("Aluno4 é maior de idade");
    	 }else {
    		 System.out.println ("Aluno4 é menor de idade");
    	 }
    	 if(idade5 >= 18) {
    		 qtdMaior = qtdMaior + 1;
    		 System.out.println ("Aluno5 é maior de idade");
    	 }else {
    		 System.out.println ("Aluno5 é menor de idade");
    	 }
